...
import ProductCardDesign3 from '../components/productCardDesign3/ProductCardDesign3'
import "./ProductsIdea3.css"
...
const ProductsIdea3 = () => {
  ...
  return (
    <div className='product_page_3'>
       {products?.map((product,index)=>(<ProductCardDesign3 prop={product} key={index}/>))} 
    </div>
  )
}

export default ProductsIdea3