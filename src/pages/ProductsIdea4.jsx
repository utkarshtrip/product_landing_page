...
import "./ProductsIdea4.css"
import ProductCardDesign4 from '../components/productCardDesign4/ProductCardDesign4'
...
const ProductsIdea4 = () => {
  ...
  return (
    <div className='product_page_4'>
        {products?.map((product,index)=>(<ProductCardDesign4 prop={product} key={index}/>))}
    </div>
  )
}

export default ProductsIdea4